    ...
    methods (Test)
        ...
        function sampleOutputsAreConsistent(testCase)
            ...
            for sample = samples
                ...
                component_summary = readtable(fullfile(component_dir, ...
                    "target_component_summary.csv"), ...
                    Delimiter=",", VariableNamingRule="preserve", TextType="string");
                testCase.verifyTrue(ismember("Sample", ...
                    string(component_summary.Properties.VariableNames)));
                testCase.verifyFalse(ismember("Dataset", ...
                    string(component_summary.Properties.VariableNames)));
                testCase.verifyEqual(string(component_summary.Sample), sample);
