...
[sample_dir, ~] = fileparts(reference_csv);
[~, sample_name] = fileparts(sample_dir);
if strlength(string(sample_name)) == 0
    sample_name = "Sample";
end
...
out_tbl = table(string(sample_name), reference_system, Ty(1), Ty(2), mu_y, sig_y, w_y, ...
    ...
    'VariableNames', {'Sample','ReferenceSystem','target_window_lo_Ma','target_window_hi_Ma', ...
